...
![Alt text](<animation 1.PNG>)

- 순순 스튜디오 에셋 사용
- Move 애니메이션은 RunNumber 0, 0.5, 1로 뛰는 상태 구분
- Action 애니메이션은 ActionState 0, 0.1, 0.2, 0.3, 0.4에 따라서 jump, jump2, greeting1, greeting2, greeting3로 구분
- 이외 앉기, 잠들기 등 애니메이션 구현되어 있음

![Alt text](loop.PNG)

- 애니메이션을 루프시키기 위해 loop pose 체크
